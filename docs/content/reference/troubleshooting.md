...
Most of these come down to network reality or how sunrise-sunset serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

sunrise-sunset rate-limits like any public site. sunrise-sunset already paces
...
Where a surface is gated, sunrise-sunset reads a cookie or token you supply
...
`sunrise-sunset`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what sunrise-sunset actually did
