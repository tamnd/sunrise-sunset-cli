...
```
sunrise-sunset <command> [arguments] [flags]
```

Run `sunrise-sunset <command> --help` for the full flag list on any command. This
...
per operation you declare in `sunrise-sunset/domain.go`.
