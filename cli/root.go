...
import (
	...
	"github.com/tamnd/sunrise-sunset-cli/sunrise-sunset"
)
...
//
// To add a command, declare it in sunrise-sunset/domain.go with kit.Handle and it
// appears here automatically. Reach for app.AddCommand only for a verb that does
// not fit the emit-records shape, the way version does below.
func NewApp() *kit.App {
	id := sunrise-sunset.Domain{}.Info().Identity
	id.Version = Version

	app := kit.New(id)
	(sunrise-sunset.Domain{}).Register(app)
